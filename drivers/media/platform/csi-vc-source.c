...
static int csi_vc_init_state(struct v4l2_subdev *sd, struct v4l2_subdev_state *state)
{
...
static const struct v4l2_subdev_internal_ops csi_vc_internal_ops = {
	.init_state = csi_vc_init_state,
};
...
static int csi_vc_probe(struct platform_device *pdev)
{
	...
	priv->subdev.internal_ops = &csi_vc_internal_ops;
...
static void csi_vc_remove(struct platform_device *pdev)
{

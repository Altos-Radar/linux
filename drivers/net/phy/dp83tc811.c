...
#define DP83TC814_RGMII_CTRL 0x0600
#define DP83TC814_RGMII_CTRL_CFG_RGMII_EN BIT(3)

#define DP83TC814_SGMII_CTRL_1 0x0608
#define DP83TC814_SGMII_CTRL_1_CFG_SGMII_EN BIT(9)

#define DP83TC814_RMII_CTRL_1 0x0648
#define DP83TC814_RMII_CTRL_1_CFG_RMII_MODE BIT(6)
...
static int dp83814_config_init(struct phy_device *phydev)
{
	...
	phy_clear_bits_mmd(phydev, DP83811_DEVADDR, DP83TC814_RGMII_CTRL, DP83TC814_RGMII_CTRL_CFG_RGMII_EN);
	phy_clear_bits_mmd(phydev, DP83811_DEVADDR, DP83TC814_SGMII_CTRL_1, DP83TC814_SGMII_CTRL_1_CFG_SGMII_EN);
	phy_clear_bits_mmd(phydev, DP83811_DEVADDR, DP83TC814_RMII_CTRL_1, DP83TC814_RMII_CTRL_1_CFG_RMII_MODE);

	switch (phydev->interface) {
	case PHY_INTERFACE_MODE_MII:
		break;
	case PHY_INTERFACE_MODE_SGMII:
		phy_set_bits_mmd(phydev, DP83811_DEVADDR, DP83TC814_SGMII_CTRL_1, DP83TC814_SGMII_CTRL_1_CFG_SGMII_EN);
		break;
	case PHY_INTERFACE_MODE_RMII:
		phy_set_bits_mmd(phydev, DP83811_DEVADDR, DP83TC814_RMII_CTRL_1, DP83TC814_RMII_CTRL_1_CFG_RMII_MODE);
		break;
	case PHY_INTERFACE_MODE_RGMII:
	case PHY_INTERFACE_MODE_RGMII_ID:
	case PHY_INTERFACE_MODE_RGMII_TXID:
	case PHY_INTERFACE_MODE_RGMII_RXID:
		phy_set_bits_mmd(phydev, DP83811_DEVADDR, DP83TC814_RGMII_CTRL, DP83TC814_RGMII_CTRL_CFG_RGMII_EN);
		break;
	default:
		return -EINVAL;
	}
